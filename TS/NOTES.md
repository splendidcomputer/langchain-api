...
## Configuring the TypeScript Compiler Options (tsconfig.json)
...
Therefore, finally your `tsconfig.json should look like this:
...
## Running our code with our confgiured TS complier

Now you can get to your bash terminal and excute all your TypsScript files in your project by simply using the `tsc` command follow by the name of your `.ts` file.

```bash
tsc index.ts
```

Now, we have a new folder called `dist` in which you can find your JS files that are generated by your configured tscompiler.

## Debugging TypeScript Applications

Go to your `tsconfig.json` file and under the **Emit** Section uncomment the `"sourceMap": true `. This feature shows us how each line of our TS code is maped into JS.
